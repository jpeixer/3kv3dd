...
- Viewer UI in **English**; click parts for labels (HIPOT, Tool Cart, Screen 13", tower lamp, BACK_CHASSIS, GraphicT, control panel, posteseg).
...
| posteseg | Poste de segurança 3X (faixa preta/amarela) |
